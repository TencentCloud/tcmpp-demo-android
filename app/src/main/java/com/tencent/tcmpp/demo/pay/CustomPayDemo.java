...
public class CustomPayDemo {
    ...
    private static class CustomPayDialog extends AlertDialog implements View.OnClickListener {
        ...
        protected CustomPayDialog(Context context, double count, int themeId) {
